...
class ShapeParams:
    ...
    def __print__(self):
        return f"major = {self.major:.2f}, minor = {self.minor:.2f}, area = {self.area:.2f}, ecc = {self.ecc:.2f}"
...
class Parameters:
    def __init__(self):
        ...
        self.EXPBGFGMODEL_SHOW_STRINGS = [
            "Prior Log-Likelihood Ratio",
        ...
        self.SHOW_EXPBGFGMODEL = [
            self.SHOW_EXPBGFGMODEL_LLR,
            self.SHOW_EXPBGFGMODEL_ISBACK,
            self.SHOW_EXPBGFGMODEL_BGMU,
            self.SHOW_EXPBGFGMODEL_FGMU,
            self.SHOW_EXPBGFGMODEL_BGSIGMA,
            self.SHOW_EXPBGFGMODEL_FGSIGMA,
            self.SHOW_EXPBGFGMODEL_FRACFRAMESISBACK,
            self.SHOW_EXPBGFGMODEL_MISSINGDATA,
        ]
        ...
        self.noninteractive_resume_tracking = (
            False  # in non-interactive mode, if we read in trajectories, should we resume tracking
        )
        ...
        self.min_jump = 50.0
        # dampening constant
        self.dampen = 0.0  # weighting term used in cvpred()
